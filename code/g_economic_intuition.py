...
def calculate_and_plot_weight_differences(weights, settings):
    """
...
# Portfolio analysis ---------------------------------------------
def portfolio_analysis(static, pfml, mkt, tpf, chars, colours_theme):
    """
    ...
    # Filter for relevant portfolio types
    filtered_long_short_weights = avg_long_short_weights[avg_long_short_weights["type"].isin(["Markowitz-ML", "Portfolio-ML", "Market"])]
